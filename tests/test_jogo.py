import pytest
from src.projeto_final.jogo import Bola, RAIO_BOLA, LARGURA_TELA, ALTURA_TELA, criar_bola_aleatoria  # Adicione a importação
...
def test_criacao_bola_aleatoria():
    ...
    bola = criar_bola_aleatoria()  # Agora está corretamente importada
